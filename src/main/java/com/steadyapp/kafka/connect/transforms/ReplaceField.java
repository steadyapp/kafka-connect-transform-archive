 ...
 * Copyright © 2020
 *
 * Enhanced version of ReplaceField Connect Transform that is
 * provided with open-source Kafka. Primary limitation of the
 * open-source simple message transform is top-level attribute
 * modifications.
 *
 * Nested attributes are acceptable. The full attribute path
 * must be specified and separated by a period(.).
 */
